...
public class Recursos implements Serializable {
    ...
    @JoinTable(name = "SUSTENTACIONES_RECURSOS", joinColumns = {
        @JoinColumn(name = "RECURSOS_ID", referencedColumnName = "ID")}, inverseJoinColumns = {
    ...
    public Recursos(BigDecimal id) {
        this.id = id;
    }

    public Recursos(BigDecimal id, String nombre) {
        this.id = id;
        this.nombre = nombre;
    }
