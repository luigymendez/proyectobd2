...
public class AnteproyectoJpaController implements Serializable {
    ...
    public void create(Anteproyecto anteproyecto) throws PreexistingEntityException, Exception {
        ...
        try {
            ...
            Estados estadosId = anteproyecto.getEstadosId();
            if (estadosId != null) {
                estadosId = em.getReference(estadosId.getClass(), estadosId.getId());
                anteproyecto.setEstadosId(estadosId);
            }
            ...
            if (estadosId != null) {
                estadosId.getAnteproyectoCollection().add(anteproyecto);
    ...
    public void edit(Anteproyecto anteproyecto) throws IllegalOrphanException, NonexistentEntityException, Exception {
        ...
        try {
            ...
            Estados estadosIdOld = persistentAnteproyecto.getEstadosId();
            Estados estadosIdNew = anteproyecto.getEstadosId();
            ...
            if (estadosIdNew != null) {
                ...
                anteproyecto.setEstadosId(estadosIdNew);
            }
            ...
            if (estadosIdOld != null && !estadosIdOld.equals(estadosIdNew)) {
                estadosIdOld.getAnteproyectoCollection().remove(anteproyecto);
                estadosIdOld = em.merge(estadosIdOld);
            }
            if (estadosIdNew != null && !estadosIdNew.equals(estadosIdOld)) {
                estadosIdNew.getAnteproyectoCollection().add(anteproyecto);
    ...
    public void destroy(BigDecimal id) throws IllegalOrphanException, NonexistentEntityException {
        ...
        try {
            ...
            Estados estadosId = anteproyecto.getEstadosId();
            if (estadosId != null) {
                estadosId.getAnteproyectoCollection().remove(anteproyecto);
                estadosId = em.merge(estadosId);
            }
